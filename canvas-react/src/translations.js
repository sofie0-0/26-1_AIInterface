...
export const translations = {
  ko: {
    ...
    errorMsg: 'AI 서버가 혼잡합니다. 잠시 후 다시 시도해주세요.',
    sideChatErrorMsg: 'AI 서버가 혼잡합니다. 잠시 후 다시 시도해주세요.',
...
`당신은 사용자의 비선형적 사고를 돕는 연구 보조원입니다. 메인 대화의 흐름을 바탕으로 이 포스트잇의 질문에 구체적으로 답해주세요.\n\n[메인 대화 내용]\n${mainCtx}`,
  ...
  en: {
    ...
    errorMsg: 'The AI server is busy. Please try again in a moment.',
    sideChatErrorMsg: 'The AI server is busy. Please try again in a moment.',
